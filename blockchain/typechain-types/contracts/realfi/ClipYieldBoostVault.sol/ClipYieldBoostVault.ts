...
export interface ClipYieldBoostVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "YIELD_DONOR_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "YIELD_DONOR_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace YieldDonatedEvent {
  export type InputTuple = [
    ...
    retainedInVault: BigNumberish
  ];
  export type OutputTuple = [
    donor: string,
    assetsIn: bigint,
    creatorPaid: bigint,
    retainedInVault: bigint
  ];
  export interface OutputObject {
    donor: string;
    assetsIn: bigint;
...
export interface ClipYieldBoostVault extends BaseContract {
  connect(runner?: ContractRunner | null): ClipYieldBoostVault;
  waitForDeployment(): Promise<this>;

  interface: ClipYieldBoostVaultInterface;
  ...
  YIELD_DONOR_ROLE: TypedContractMethod<[], [string], "view">;
  ...
  donateYield: TypedContractMethod<
    [assets: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "YIELD_DONOR_ROLE"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  filters: {
    ...
    "YieldDonated(address,uint256,uint256,uint256)": TypedContractEvent<
      YieldDonatedEvent.InputTuple,
      YieldDonatedEvent.OutputTuple,
      YieldDonatedEvent.OutputObject
    >;
