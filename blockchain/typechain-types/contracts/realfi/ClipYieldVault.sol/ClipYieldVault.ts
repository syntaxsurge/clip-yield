...
export interface ClipYieldVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MANAGER_ROLE"
...
export interface ClipYieldVault extends BaseContract {
  connect(runner?: ContractRunner | null): ClipYieldVault;
  waitForDeployment(): Promise<this>;

  interface: ClipYieldVaultInterface;
  ...
  filters: {
    ...
    "YieldDonated(address,uint256)": TypedContractEvent<
      YieldDonatedEvent.InputTuple,
      YieldDonatedEvent.OutputTuple,
      YieldDonatedEvent.OutputObject
    >;
